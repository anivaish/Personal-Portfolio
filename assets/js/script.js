...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Aniruddh Vaish";
...
var typed = new Typed(".typing-text", {
    strings: ["Full stack development", "Front-end development", "Back-end development", "Web designing", "Problem Solving"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showTools(tools) {
    ...
    let toolHTML = "";
    tools.forEach(tool => {
        if (tool.name === "CodePen")
            toolHTML += `
        <div class="bar">
              <div class="info">
                <i class="fa-brands fa-codepen" style="color: #ffffff;"></i>
                <span>${tool.name}</span>
              </div>
            </div>`
        else
